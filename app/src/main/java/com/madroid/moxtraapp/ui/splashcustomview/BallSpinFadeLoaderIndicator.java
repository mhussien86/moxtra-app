package com.madroid.moxtraapp.ui.splashcustomview;

/**
 * Created by mohamed on 14/04/17.
 */
...
//    }
    ...
    public ArrayList<ValueAnimator> onCreateAnimators() {
        ...
        int[] delays= {0, 120, 240, 360, 480, 600, 720, 780, 840, 960, 1080};
        for (int i = 0; i < 11; i++) {
            final int index=i;
